...
<article class="content grid">
	...
	<TitledSection id="terminal" class="ultrawide content bg-card/40 grid">
		{#snippet title()}
			Terminal
		{/snippet}
		<List>
	...
	<TitledSection id="desktop-apps" class="ultrawide content bg-card/40 grid">
		{#snippet title()}
			Desktop Apps
		{/snippet}
		<List>
	...
	<TitledSection id="cli" class="breakout content bg-card grid">
		{#snippet title()}
			CLIs
		{/snippet}
		<List>
	...
	<TitledSection id="inspiration" class="ultrawide content bg-card/40 grid">
		{#snippet title()}
			Inspiration
		{/snippet}
		<List>
